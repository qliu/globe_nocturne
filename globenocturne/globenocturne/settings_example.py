"""
Django settings for globenocturne project.
...
SECRET_KEY = '%b%73-_ox9ct$gv2-#13*fed9n!yv83ndl0)cxu8#fs22&t8(d'
...
ROOT_URLCONF = 'globenocturne.urls'

WSGI_APPLICATION = 'globenocturne.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': 'postgres',
        'HOST': '/opt/bitnami/postgresql',#'/opt/bitnami/postgresql' for aws
        'PORT': '5432'        
    }    
}
...
#ROOT_APP_URL = '/globenocturne' # use this for localhost
ROOT_APP_URL = '/globenocturne/globenocturne' # use this for server

#ADMIN_ROOT_URL = '' # use this for localhost
ADMIN_ROOT_URL = '/globenocturne' # use this for server

STATIC_ROOT_URL = '/globenocturne'
STATIC_URL = '%s/static/' % STATIC_ROOT_URL

# Login URL
#LOGIN_URL = '/admin/login/' # use this for localhost
LOGIN_URL = '/globenocturne/admin/login/'
